...
```
cd build
cleos -u 'http://openapi.eos.ren' set contract resource.tp ./flashloantest -p resource.tp
```
...
###　测试环境
```
cleos -u 'https://kylin.eos.dfuse.io' set contract tptpresource ./flashloantest -p tptpresource
